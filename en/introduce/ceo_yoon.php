		...
		<div class="container">
			<nav class="navbar">
				<ul class="nav navbar-nav">
					<li><a href="/en/introduce/greeting.php">인사말</a></li>
					<li class="active"><a href="/en/introduce/ceo_yoon.php">CEO 윤희진</a></li>
					<li><a href="/en/introduce/ceo_min.php">CEO 민동수</a></li>
				</ul>
			</nav>
			<section class="ceo-info">
				<div class="section-header">
                    <p>
                        <img src="/en/assets/images/introduce/ceo_img01.png" alt="ceo 윤희진" />
                    </p>
