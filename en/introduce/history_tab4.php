		...
		<div class="container">
			<nav class="navbar">
				<ul class="nav navbar-nav">
					<li class="active"><a href="/en/introduce/history_tab4.php">1980년대</a></li>
					<li><a href="/en/introduce/history_tab3.php">1990년대</a></li>
					<li><a href="/en/introduce/history_tab2.php">2000년대</a></li>
			...
			<div class="history-list">
				<div class="history-img">
					<p>
						<img src="/en/assets/images/introduce/history_img15.jpg" alt="기업연혁이미지">
					</p>
					<p>
						<img src="/en/assets/images/introduce/history_img16.jpg" alt="기업연혁이미지">
					</p>
				</div>
				<ol>
					<li>
