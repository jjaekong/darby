...
<body>
	...
	<main id="content" tabindex="-1" class="business stain-pig">
		<div class="container">
			<nav class="navbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/en/business/product/stain_pig.php">한돈 브랜드육</a></li>
					<li><a href="/en/business/product/purchase.php">구입문의</a></li>
				</ul>
			</nav>
			<section class="stain-pig">
				<div class="section-header">
					<h3>얼룩도야지</h3>
					<hr>
				</div>
				<p>
					<img src="/en/assets/images/business/stain_pig.jpg" alt="웰팜한돈">
				</p>
				<h4>대한민국 0.3% 얼룩돼지</h4>
				<p>
				...
				<h5>품종개량의 체계</h5>
				<p>
				    <img src="/en/assets/images/business/breeding_table.jpg" alt="품종개량 표">
				</p>
                    ...
                    <div class="table-wrap">
                        <table class="table table-border">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>듀록</td>
                                    <td>3.07<sup>b</sup></td>
                                    <td>6.3<sup>cd</sup></td>
                                    <td>5.4<sup>c</sup></td>
                                </tr>
                                <tr>
                                    <td>랜드레이스</td>
                                    <td>1.9<sup>e</sup></td>
                                    <td>6.6<sup>bc</sup></td>
                                    <td>5.0<sup>d</sup></td>
                                </tr>
                                <tr>
                                    <td>요크셔</td>
                                    <td>1.70<sup>l</sup></td>
                                    <td>6.3<sup>cd</sup></td>
                                    <td>4.9<sup>d</sup></td>
                                </tr>
                            </tbody>
			...
			<section class="han-don">
			    ...
			    <p>
			        <img src="/en/assets/images/business/handon_img.jpg" alt="듀록한돈">
			    </p>
			    <h5>육질을 위해 태어난 품종, 육질혁명!</h5>
			    <p>
			        듀록은 육질이 뛰어난 품종으로 일반 돼지고기에 비해 뛰어난 마블링과 식감을 자랑합니다.또한 풍부한 육즙과 고소한 맛으로 풍미가 뛰어납니다.<br>
			        다비육종은 지속적인 육질검사를 통해 수집한 데이터를 바탕으로 듀록의 육질을 더욱 향상시키고 있습니다.
			    </p>
			</section>
		</div>
	</main>
