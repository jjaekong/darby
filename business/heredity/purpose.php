...
<body>
	...
	<main id="content" tabindex="-1" class="business heredity purpose">
		<div class="container">
			<nav class="navbar">
				<ul class="nav navbar-nav">
					<li><a href="/business/heredity/production.php">생산농장</a></li>
					<li><a href="/business/heredity/business.php">육종개량시스템</a></li>
					<li class="active"><a href="/business/heredity/purpose.php">방역/위생관리<br>시스템</a></li>
			...
			<section class="method">
				...
				<p>
				    <img src="/assets/images/business/method_img.jpg" alt="발라드 동물병원 위생 관리방법 이미지">
				</p>
			</section>
			<section class="biosecurity">
				<div class="section-header">
					<h3>차단방역시스템 (BIOSECURITY)</h3>
					<hr>
				</div>
