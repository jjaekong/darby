...
<body>
	...
	<main id="content" tabindex="-1" class="business breeding-pig">
		<div class="container">
			<nav class="navbar">
			...
			<section class="yorkshire-landrace">
				...
				<div class="sort">
					...
					<div class="graph">
						<img src="/assets/images/business/graph02.jpg" alt="생존산자수 그래프">
						<p>디앤디 YY 생존산자수</p>
						<p>성진 YY 생존산자수</p>
					</div>
				</div>
			...
			<section class="marblur">
				...
				<figure>
					<img src="/assets/images/business/pig_img03.gif" alt="마블러-S">
					<figcaption>마블러-S</figcaption>
				</figure>
