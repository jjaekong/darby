...
<div class="container">
	...
	<ul class="nav nav-pills nav-justified">
		<li role="presentation" class="<?=$BoardName=="reviewforeign"?"active":""?>"><a href="/community/review_list.php?workType=reviewforeign">외래</a></li>
		<li role="presentation" class="<?=$BoardName=="reviewenter"?"active":""?>"><a href="/community/review_list.php?workType=reviewenter">입원</a></li>
	</ul>
	<? } ?>
