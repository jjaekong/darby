...
switch($workType){
	...
	case "AM":
		...
		if(!$admin_pwd) $admin_ppwd = $row["admin_pwd"];
		break;
}
...
switch($workType){
	...
	case "CI":
		...
		$sql = " insert into ".$mode." set part = '".$part."', partorder = '".$partorder."', name = '".$name."', chargeorder = '".$chargeorder."', $sql_common etc = '".$etc."' ";
		$result = sql_query($sql);
		$works = "입력";
	...
	case "CM":
		...
		$mode = $site_prefix."charge";
		$sql = " update ".$mode." set part = '".$part."', partorder = '".$partorder."', name = '".$name."', chargeorder = '".$chargeorder."', $sql_common etc = '".$etc."' where idx = '".$idx."' ";
		$result = sql_query($sql);
		$works = "수정";
		break;
	case "AD":
	...
	case "USE":
	case "PERSON":
		$sql = " update ".$site_prefix."agree set agree1 = '".$agree1."', agree2 = '".$agree2."' where idx = '".$idx."' ";
		$result = sql_query($sql);
		$works = "수정";
		break;
}
