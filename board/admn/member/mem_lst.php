...
<div id="container">
	<div class="content_view">
		...
		<div class="mt5 mr10 btn_group"><button type="button" class="btn_a_n" onclick="excel_down();">엑셀다운</button>&nbsp;<button type="button" class="btn_a_b" onclick="board_write();">등 록</button></div>
