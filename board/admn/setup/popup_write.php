...
<div id="container">
	<div class="content_view">
		...
		<table class="write_table mt15">
			...
			<tr>
				<th>제목 </th>
				<td><input type="text" class="input wd320" name="Title" value="<?=$row["Title"]?>" exp title="제목" ></td>
			</tr>
			<tr>
				<th>링크주소 </th>
				<td>
			...
			<tr>
				<th>팝업기간 </th>
				<td>
					<input type="text" class="input wd100 datepick" name="start_date" value="<?=$sdate?>" exp title="시작일" readonly >&nbsp;
					...
					~&nbsp;<input type="text" class="input wd100 datepick" name="end_date" value="<?=$edate?>" exp title="종료일" readonly >&nbsp;
