...
<div id="container">
	<div class="content_view">
		...
		<div class="mt20 mb5">
			...
			<a href="<?=$_SERVER['PHP_SELF']?>?bloc=M"><?=$t01?>[메인-비쥬얼]</b></a>&nbsp;<a href="<?=$_SERVER['PHP_SELF']?>?bloc=M2"><?=$t02?>[메인-하단협력기관]</b></a>&nbsp;<a href="<?=$_SERVER['PHP_SELF']?>?bloc=M3"><?=$t03?>[메인-동영상링크]</b></a>&nbsp;<a href="<?=$_SERVER['PHP_SELF']?>?bloc=M4"><?=$t04?>[모바일메인-비쥬얼]</b></a>
		</div>
