...
<div id="navigation_left">
	...
	<div class="navi_box mt10">
		<ul>
			...
			<li class="navi_menu"><a href="javascript:;" onclick="gf_goUrl('107')" class="<?=$t107?>">예약관련설정</a></li>
			<li class="navi_menu"><a href="javascript:;" onclick="gf_goUrl('108')" class="<?=$t108?>">연혁관리</a></li>
		</ul>
	</div>
	<?
			break;
