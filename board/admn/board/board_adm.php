	...
	<div class="content_view">
		...
		<table class="write_table mt15">
			<tr>
				...
				<td width="290"><input type="text" class="input" name="BoardName" style="width:150px" exp title="게시판코드" value="<?=$brow["BoardName"]?>">&nbsp;사용여부 <input type="checkbox" name="Flag" value="1" <?=$brow["Flag"]?"checked":""?>></td>
				<th width="100">게시판이름</th>
				<td width="290"><input type="text" class="input" name="BoardTitle" style="width:250px" exp title="게시판이름" value="<?=$brow["BoardTitle"]?>"></td>
			</tr>
			<tr>
				<th>읽기권한</th>
				<td>
			...
			<tr>
				<th>첨부파일개수</th>
				<td><input type="text" class="input" name="FileCnt" style="width:50px" exp title="첨부파일개수" value="<?=$brow["FileCnt"]?$brow["FileCnt"]:"1"?>"></td>
				<th>카테고리</th>
