	...
	<main id="content" tabindex="-1" class="introduce ceo-min">
		<div class="container">
			...
			<div class="ceo-info">
				...
				<h3>경력 및 실적</h3>
				<p>
				    1993년 돼지인공수정 기법을 본격적으로 도입하여 국내 최초 돼지인공수정센터인 다비 SP(Semen Production)센터의 발전을 선도하였다. 또한 종돈 및 정액 판매를 위한 체계적인 판매시스템을 구축하여 매년 국내 종돈 및 정액 판매량의 신기록을 갱신하고 있다. 2005년에는 다비육종의 프리미엄 돈육 브랜드인 웰팜포크(현 얼룩도야지)를 출시하여 맛있는 돈육을 소비자에게 공급하고 있다. 이 외에도 2007년 CQM(Challenge 27 Quality Management Committee) 고객농장 연간 PSY 27두 달성, 2015년 국내 최초 디앤디GGP PSY 30두 달성 등 다비육종이 국내 종돈업을 대표하는 기업으로 발전하는 데 있어 큰 기여를 하였다.
				</p>
				<p>
