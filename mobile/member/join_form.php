		...
		<div class="container">
						...
						<table>
							...
							<tbody>
								<tr class="user-id">
									...
									<td>
										<input type="text" class="form-control" id="user-id" name="UserID" id="UserID" exp uid title="아이디">
										<div class="btn-area">
											<p>
												<a href="javascript:;" onclick="id_chk();" class="btn btn-gray">중복검사</a>
											</p>
										</div>
										<span id="span_idck"><input type="hidden" name="idchk" value="No"></span>
									</td>
								</tr>
								<tr>
									<th><label for="user-name">이름</label></th>
									<td>
										<input type="text" class="form-control" id="user-name" name="UserName" exp title="이름" value="<?=$name?>">
									</td>
								</tr>
								<tr>
									<th><label for="password">비밀번호</label></th>
									<td>
										<input type="password" class="form-control" id="Password1" name="Password1" exp title="비밀번호">
									</td>
								</tr>
								<tr>
									<th><label for="pw-check">비밀번호<br>확인</label></th>
									<td>
										<input type="password" class="form-control" id="Password2" name="Password2" exp title="비밀번호 확인">
									</td>
								</tr>
								<tr class="user-id">
									<th><label for="email-addr">이메일</label></th>
									<td>
										<input type="email" class="form-control" name="Email" id="email-addr" exp title="이메일">
										<div class="btn-area">
											<p>
								...
								<tr class="sex">
									<th>성별</th>
									<td>
										<label><input type="radio" name="Sex" id="sex" value="M" checked>&nbsp;남자</label>
										<label><input type="radio" name="Sex" id="woman" value="F">&nbsp;여자</label>
									</td>
								</tr>
								<tr class="address">
									<th><label for="address">주소</label></th>
									<td>
										<input type="text" class="form-control" name="ZipCode" exp title="우편번호" readonly id="address" placeholder="우편번호">
										<div class="btn-area">
											<p>
												<a href="javascript:;" onclick="win_zip('MemberForm', 'ZipCode', 'Address1', 'Address2', 'Address3', 'AddressType');" class="btn btn-gray">우편번호 검색</a>
											</p>
										</div>
										<label class="sr-only" for="detailed-addr"></label><input type="text" class="form-control" name="Address1" exp title="주소" id="detailed-addr" placeholder="기본주소">
										<label class="sr-only" for="house-number"></label><input type="text" class="form-control" name="Address2" exp title="주소" id="house-number" placeholder="상세주소"></label>
										<label class="sr-only" for="house-number"></label><input type="text" class="form-control" name="Address3" readonly id="road-addr" placeholder="도로명주소"><input type="hidden" name="AddressType"></label>
									</td>
								</tr>
								<tr>
			...
			<div class="btn-area">
				<p>
					...
					<a href="javascript:;" onclick="javascript:FormOK();" class="btn btn-gray">가입완료</a>
				</p>
			</div>
		</div>
	</main>
	...
	function FormOK(){
		...
		if(FormCheck(form) == true){
			...
			if($("#Password1").val().length < 5 || $("#Password1").val().length > 12){
				alert("비밀번호는 5~12자리로 입력하시기 바랍니다.");
				form.Password1.value == "";
				form.Password1.focus();
				return;
			}
